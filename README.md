...
1. Download or clone this [repostory](https://github.com/Megagig/Hello_rails_react).
...
- Clone this [repository](https://github.com/Megagig/Hello_rails_react) to your desired folder:

- Run this command in your command line interface:

```sh
  cd [YOUR FOLDER]
  git clone https://github.com/Megagig/Rails-React-App
...
Feel free to check the [issues page](https://github.com/Megagig/Hello_rails_react/issues).
...
If you like this project, kindly drop a start ⭐️ for the [repository](https://github.com/Megagig/Hello_rails_react);
